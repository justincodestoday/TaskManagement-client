...
export const getList = async (id) => {
    try {
        const res = await fetch(
            `${process.env.REACT_APP_API_SERVER}/lists/${id}`,
            {
                headers: {
                    "x-auth-token": localStorage.getItem("token"),
                },
...
export const getCardsInBoard = async (boardId) => {
    try {
        const res = await fetch(
            `${process.env.REACT_APP_API_SERVER}/cards/board-cards/${boardId}`,
            {
                headers: {
                    "x-auth-token": localStorage.getItem("token"),
                },
...
export const getCard = async (id) => {
    try {
        const res = await fetch(
            `${process.env.REACT_APP_API_SERVER}/cards/${id}`,
            {
                headers: {
                    "x-auth-token": localStorage.getItem("token"),
                },
