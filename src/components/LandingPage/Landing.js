...
import Theme from "../../images/landingwallpaper.webp";
import Logo from "../../images/Logos/logo-white-background-alt.jpeg";
            ...
            <div className="relative px-4 pt-6 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="hidden md:ml-10 md:block md:space-x-8 md:pr-4">
                  ...
                  <Link
                    to="/register"
                    className="font-medium text-white bg-purple-600 rounded-md py-2 px-4 hover:bg-purple-700"
                  >
            ...
            >
              ...
              >
                <div className="overflow-hidden rounded-lg bg-white shadow-md ring-1 ring-black ring-opacity-5">
                  ...
                  <Link
                    to="/login"
                    className="block w-full bg-gray-50 px-5 py-3 text-center font-medium text-purple-600 hover:bg-gray-100"
                  >
                    <button>Sign in</button>
                  </Link>
                  <Link
          ...
          <main className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Time to enhance your</span>{" "}
                <span className="block text-purple-600 xl:inline">
                  productivity
                </span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0">
                Weekee provides you the tools to organize your tasks seamlessly
                and aesthetically without a hiccup. It's as easy as moving your
                sticky notes around.
              </p>
