    ...
    <>
      <div className="min-h-full">
        ...
        <header className="bg-white shadow">
          <div className="mx-auto max-w-full py-6 px-4 sm:px-6 lg:px-8">
        ...
        <main>
          <div className="mx-auto max-w-full py-6 sm:px-6 lg:px-8">
            ...
            <section className="grid grid-cols-1 gap-0 sm:grid-cols-2 sm:gap-4 md:grid-cols-3 lg:grid-cols-4">
              {/* <div className=""> */}
              {data.map((board) => (
